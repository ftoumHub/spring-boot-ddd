...
public class PerformPaymentRequest {
    ...
    @ValidEnum(conformsTo = PaymentIntent.class) private String paymentIntent;
    @ValidEnum(conformsTo = PaymentMethod.class) private String paymentMethod;
    @Valid private Transaction transaction;
}
