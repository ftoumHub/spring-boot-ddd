...
public class Money implements ValueObject<Money> {
    ...
    @ValidEnum(conformsTo = CurrencyCodes.class) public final String currency;
    @NotNull public final Integer amount;
    @NotNull public final Integer scale;
    @JsonIgnore public final BigDecimal amountAsBigDecimal;
