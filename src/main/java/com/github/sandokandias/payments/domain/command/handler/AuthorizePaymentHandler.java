...
@Component
public class AuthorizePaymentHandler implements CommandHandler<PaymentCommand.AuthorizePayment, PaymentAuthorized, PaymentId> {
    ...
    @Override
    public CompletionStage<Either<CommandFailure, PaymentAuthorized>> handle(PaymentCommand.AuthorizePayment command, PaymentId entityId) {
